...
public class DepartureBeforeCurrentTimeTest {
    ...
    public void test() {
        ...
        List<Flight> actual = filter.departureBeforeCurrentTime(createFlights());
    ...
    private List<Flight> createFlights() {
        ...
        segments_2.add(new Segment(now().minusDays(1), now().plusHours(1)));
        segments_3.add(new Segment(now().plusHours(2), now().plusHours(4)));
        segments_4.add(new Segment(now().minusHours(1), now().plusHours(1)));
